...
public class DBDataSource {
    ...
    private String[] allColumns = { DBHelper.COLUMN_ID,
            DBHelper.COLUMN_NAME, DBHelper.COLUMN_HARGA};
    ...
    public Barang createBarang(String nama, String harga) {
    ...
    private Barang cursorToBarang(Cursor cursor)
    {
        ...
        barang.setNama_menu(cursor.getString(1));
        barang.setHarga_menu(cursor.getString(2));
    ...
    public void updateBarang(Barang b)
    {
        ...
        args.put(DBHelper.COLUMN_NAME, b.getNama_menu());
        args.put(DBHelper.COLUMN_HARGA, b.getHarga_menu() );
        //update query
