...
import com.example.finalproject.e_kantin_pemnjual.Barang;
import com.example.finalproject.e_kantin_pemnjual.DBDataSource;
import com.example.finalproject.e_kantin_pemnjual.R;
...
public class ViewData extends ListActivity implements AdapterView.OnItemLongClickListener {
    ...
    public void switchToEdit(long id) {
        ...
        bun.putString("nama", b.getNama_menu());
        bun.putString("harga", b.getHarga_menu());
        i.putExtras(bun);
        finale();
        startActivity(i);
    }
    ...
    public void pindah(View view) {
        Intent p = new  Intent(ViewData.this, CreateData.class);
        startActivity(p);
    }
}